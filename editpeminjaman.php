...
if($hal == 'edit'){
    ...
    $sql =  'select * from data where id_anggota = "$id_anggota"';
...
if(isset($_POST['simpan'])){
    ...
    if($id_anggota && $nama_angggota && $judul_buku && $penulis && $tanggal_peminjaman && $tanggal_pengembalian){
        if($hal == 'edit'){
            $sql = "update data set nama_angggota='$nama_angggota',judul_buku='$judul_buku',penulis ='$penulis',tanggal_peminjaman='$tanggal_peminjaman',tanggal_pengembalian='$tanggal_pengembalian' where id_anggota = '$id_anggota'";
            $ql = mysqli_query($koneksi,$sql);
            ...
            $sql = "insert into data(nama_anggota,judul_buku,penulis,tanggal_peminjaman,tanggal_pengembalian) values('$nama_anggota','$judul_buku','$penulis','$tanggal_peminjaman','$tanggal_pengembalian')";
            $ql = mysqli_query($koneksi,$sql);
            if($sql){
            ...
            <div class="card-body">
                ...
                <form action="#" class="form" method="POST">
                    <div class="input-box">
                        ...
                        <input type="text" class="form-control" id="id_anggota" name="id_anggota" placeholder="Masukkan ID Anggota" value="<?php echo $id_anggota ?>">
                    </div>
                    <div class="input-box">
                        <label for="nama_angggota" class="col-sm-2 col-form-label">Nama Anggota</label>
                        <input type="text" class="form-control" id="nama_angggota" name="nama_angggota" placeholder="Masukkan Nama Anggota" value="<?php echo $nama_angggota ?>">
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <label for="judul_buku" class="col-sm-2 col-form-label">Tanggal Peminjaman</label>
                    ...
                    <div class="input-box">
                        <label for="judul_buku" class="col-sm-2 col-form-label">Tanggal Pengembalian</label>
                        <input type="text" class="form-control" id="tanggal_pengembalian" name="tanggal_pengembalian" placeholder="Masukkan Tanggal Pengembalian" value="<?php echo $tanggal_pengembalian ?>">
                    </div>
                    <div class="user">
