...
if($hal == 'edit'){
    ...
    $sql =  'select * from denda where id_anggota = "$id_anggota"';
...
if(isset($_POST['simpan'])){
    ...
    if($id_anggota && $nama_angggota && $judul_buku && $tanggal_pengembalian && $tanggal_kembali){
        if($hal == 'edit'){
            $sql = "update denda set id_anggota='$id_anggota',nama_angggota='$nama_angggota',judul_buku='$judul_buku',tanggal_pengembalian='$tanggal_pengembalian',tanggal_kembali='$tanggal_kembali' where id_anggota = '$id_anggota'";
            $ql = mysqli_query($koneksi,$sql);
            ...
            $sql = "insert into denda(nama_angggota,judul_buku,tanggal_pengembalian,tanggal_kembali) values('$nama_angggota','$judul_buku','$tanggal_pengembalian','$tanggal_kembali')";
            $ql = mysqli_query($koneksi,$sql);
            if($sql){
            ...
            <div class="card-body">
                ...
                <form action="#" class="form" method="POST">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" class="form-control" id="tanggal_kembali" name="tanggal_kembali" placeholder="Masukkan Tanggal Kembali" value="<?php echo $tanggal_kembali ?>">
                    </div>
                    <div class="user">
